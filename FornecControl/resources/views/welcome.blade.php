        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    @auth
                        <a href="{{ url('/home') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Início</a>
                    @else
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <img src="{{ asset('/vendor/adminlte/dist/img/AdminLTELogo.png') }}" style="
                    width: 128px;
                    filter: invert(1);
                " alt="My Image">
                </div>
                ...
                <div class="mt-16">
                    <div class="container">
                        <div class="row"><p class="h1" style="
                        ...
                        margin-right: 10%;
                        text-align: center;
                        ">Gerencie seus fornecedores com eficiência.</p></div>
                        <div class="row">
                            <div style="
                            color: white;
                            text-align: center;
                            width: 50%;
                            margin-left: 25%;
                        "><p>Este aplicativo tem como objetivo gerenciar fornecedores e empresas de forma simples e eficiente. Ele permite que você cadastre empresas com informações como endereço, nome fantasia e CNPJ, e fornecedores com informações como empresa, nome, CPF/CNPJ, data/hora de cadastro e telefone.</p>
